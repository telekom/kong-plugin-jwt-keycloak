...
local security_event = require("kong.plugins.jwt-keycloak.gateway.securitylog").security_event
local set_gateway_consumer = require("kong.plugins.jwt-keycloak.gateway.securitylog").collect_gateway_data
