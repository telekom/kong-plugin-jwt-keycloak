...
| config.allowed_iss                     | yes     |                   | A list of allowed issuers for this route/service/api. Entries are matched using exact string equality against the token's `iss` claim. |
